...
L2FC_SUM1 <- summarize(gene_l2fc_htseqSalmon1_combo, 
                          HTSeq_L2FC_only = sum((!is.na(L2FC_HTSEQ)) & (is.na(L2FC_SALMON))),
                          SalmonL2FConly = sum((is.na(L2FC_HTSEQ)) & (!is.na(L2FC_SALMON))),
...
barplot(L2FC_SUM1_mat, main = "Summary of 'HTSEQ' vs. 'SALMON' L2FC", xlab = "Tool", ylab = "Number of Genes", col="blue")
