...
Optimizing compatability for creating DataSets for DESEQ2 (EDITS = DONE) , !!MAY need to consider separating into two code chunks!!
```{r Creating matricies / ordering and setting row names and col names}
...
resDseq_salmonCopy$Gene <- rownames(resDseq_salmonCopy)
